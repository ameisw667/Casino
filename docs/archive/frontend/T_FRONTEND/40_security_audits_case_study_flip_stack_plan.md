...
> **Status:** Completed & Archived · **Stand:** 2026-09-11 · **Owner:** LLM (100 % LLM-Zuständigkeit) · **Scope:** Integration eines interaktiven 3D-Kartenstapels (`case-study-flip-stack`) für Sicherheitszertifikate und Auszahlungs-Audits im Footer (`src/components/layout/Footer.tsx`).
