...
- [x] **Kritischer Selbstcheck:** L1 wird zwangsläufig neue TypeScript-Fehler aufdecken — das wurde explizit als _erwartetes, gewolltes_ Verhalten dokumentiert (Abschnitt 0 Punkt 3), damit eine ausführende LLM-Instanz nicht fälschlich denkt, sie hätte etwas kaputt gemacht und die Änderung zurückrollt.
