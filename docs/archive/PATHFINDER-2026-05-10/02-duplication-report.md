...
**Accidental Duplication**: The _validation framework_ is identical.
...
All 4 games duplicate the _post-game workflow_:
...
**Legitimate Specialization**: Payout _calculation_ differs:
...
**Accidental Duplication**: The _notification framework_ is identical.
...
**Accidental**: Sound effects differ per game, but the _caching pattern_ is identical.
...
- **Legitimate**: Toast message _content_ is game-specific (e.g., "Won with 8.5x multiplier" vs "Lucky 7s!")
- **Accidental**: Toast _triggering logic_ is identical
...
// Usage:
GameNotificationCenter.showWin('CRASH', 25.5, '8.5x multiplier');
...
**Legitimate**: Animation _target_ differs:

- Crash: Exponential curve graph
- Roulette: 3D wheel rotation
- Slots: Reel scrolling

**Accidental**: RAF _setup_ code is identical.
