...
| 9   | Reduced-Motion-Zugänglichkeit fehlte                                | Bewegungs-sensible Nutzer nicht berücksichtigt, obwohl Codebase-Muster existiert ([games/page.tsx:595](../../src/app/games/page.tsx)) | `prefersReducedMotionRef` (live via `matchMedia`-Listener), Puls/Zoom auf 0 bei aktivierter Einstellung, Vignette bleibt (Farb-/Opacity-Cue, keine Bewegung) |
