...
- **Scope:**
  ...
  - Textanzeige mit Status-Label und dynamischem Tipp (z.B. *„Füge Sonderzeichen hinzu“*).
...
- **Scope:**
  ...
  5. `worldmap/20_authentication.md` (Level 7 auf 🟢 Executed setzen).
