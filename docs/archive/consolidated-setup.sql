-- ARCHIVED 2026-08-28 (docs/archive/05_datenbank_haertung.md, Teil A/L5): moved out of
-- supabase/ because it only ever covered migrations 001-007 of the 59 that now
-- exist and had no live function since the project's first bootstrap. Kept here
-- for historical reference only — not part of any active workflow.
--
