...
> **Status:** Executed (archiviert) · **Stand:** 2026-09-12 · **Owner:** LLM (100 % LLM-Zuständigkeit) · **Scope:** Implementierung einer geführten, cineastischen VIP-Feature-Tour (`sticky-scroll-cards`) im Onboarding-Dialog (`src/components/layout/OnboardingFlow.tsx`).
