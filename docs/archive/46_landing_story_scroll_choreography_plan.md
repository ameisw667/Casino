...
> **Status:** Executed (archiviert) · **Stand:** 2026-09-12 · **Owner:** LLM (100 % LLM-Zuständigkeit) · **Scope:** Parallaktische Scroll-Synchronisation (`scroll-choreography`) der Lobby-Storyline und VIP-Sektionen (`src/components/home/LobbySectionHeader.tsx`).
