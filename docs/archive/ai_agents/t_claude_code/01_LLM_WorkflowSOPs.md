...
- **Universelle Logik:**
  ...
  3. Pre-Mortem-Pflicht für die Führungsoption: _"Scheitert diese Option in 6 Monaten, woran läge es?"_
...
Eine NTFS Directory Junction (`mklink /J`) ist ein _NTFS Reparse Point_ auf Kernel-Ebene. Für alle lokalen Werkzeuge (Node.js `fs`, Windows Explorer, PowerShell, Antigravity, Claude Code) verhält sich der verknüpfte Ordner exakt wie ein nativer, lokaler Unterordner im Projekt:
