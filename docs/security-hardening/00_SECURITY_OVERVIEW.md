...
Diese Schicht ist kein einzelnes Feature, sondern **10 einzeln bewertbare Härtungsmaßnahmen**, die zusammen die Angriffsfläche der App absichern, ohne dass ein Spieler davon je etwas im UI sieht (im Gegensatz zu Auth). Bewusst nach demselben „max. 10 Unterkategorien“-Schema gegliedert wie [`T_SECURITY_HARDENING/04_security_hardening.md`](../../T_SECURITY_HARDENING/04_security_hardening.md), aber pro Maßnahme mit eigener Implementierungs-Blaupause statt nur Bewertung.
...
| Bedarf                                                                                 | Datei                                                                                                                    |
| :------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------- |
| Sub-Kategorie-Bewertung / Bottleneck-Analyse (Herkunft dieser Struktur)                | [`T_SECURITY_HARDENING/04_security_hardening.md`](../../T_SECURITY_HARDENING/04_security_hardening.md)                   |
