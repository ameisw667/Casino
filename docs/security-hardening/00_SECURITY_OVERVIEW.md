...
Diese Schicht ist kein einzelnes Feature, sondern **10 einzeln bewertbare Härtungsmaßnahmen**, die zusammen die Angriffsfläche der App absichern, ohne dass ein Spieler davon je etwas im UI sieht (im Gegensatz zu Auth). Bewusst nach demselben „max. 10 Unterkategorien“-Schema gegliedert wie [`T_SECURITY_HARDENING/04_security_hardening.md`](../../workspace/domains/security/T_SECURITY_HARDENING/04_security_hardening.md), aber pro Maßnahme mit eigener Implementierungs-Blaupause statt nur Bewertung.
...
| **7**  | **Dependency-/Supply-Chain-Audit-Gate**       | `audit-ci` mit getrackter Allowlist als Hard-Gate + SBOM-Export.                                                                                             | Blockiert Merges mit neuen High/Critical-Schwachstellen in Abhängigkeiten.                                                              | 🟡 **Live grün** (Update 2026-09-06) — nur noch der bekannte, allowlistete `ws`-Fund offen (K5, bei Jan); `brace-expansion`/`js-yaml` nicht mehr im Baum. Details: [`07_dependency_supply_chain_audit.md`](07_dependency_supply_chain_audit.md). |
...
| Bedarf                                                                                 | Datei                                                                                                                             |
| :------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------- |
| Sub-Kategorie-Bewertung / Bottleneck-Analyse (Herkunft dieser Struktur)                | [`T_SECURITY_HARDENING/04_security_hardening.md`](../../workspace/domains/security/T_SECURITY_HARDENING/04_security_hardening.md) |
