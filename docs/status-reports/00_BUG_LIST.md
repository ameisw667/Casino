...
- **Update 2026-08-07**: Payout-Berechnung läuft jetzt über `calculateSlotsPayoutWithConfig()` (config-getrieben statt hartcodiert) — Teil der Supabase-Auslagerung ([Worldmap-Status](../../worldmap/00_WORLDMAP_STATUS.md), Kategorie 12: „Parameter raus, Algorithmus bleibt"). Die 57,70%-Zahl von 2026-06-12 ist damit veraltet; aktueller RTP hängt vom aktiven `game_configs`-Eintrag ab (Remote-Status unbestätigt, siehe Kategorie 12). Ziel-RTP-Entscheidung weiterhin offen.
