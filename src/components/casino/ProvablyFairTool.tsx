...
export default function ProvablyFairTool() {
  ...
  const [results, setResults] = useState<{ dice: string; crash: string; slots: number[] }>({
    dice: '0.00',
    crash: '1.00',
    slots: [0, 0, 0, 0, 0],
  });
  ...
  React.useEffect(() => {
    const calculate = async () => {
      try {
        ...
        const crash = (
          await ProvablyFairEngine.getCrashMultiplier(serverSeed, clientSeed, nonce)
        ).toFixed(2);
  ...
  return (
    <div
      ...
      style={{ maxWidth: '600px', width: '100%', padding: isMobile ? '20px' : '32px' }}
    >
      <div
        style={{
          display: 'flex',
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            ...
            <button
              ...
              style={{ padding: '8px', width: '44px', height: '44px' }}
        ...
        >
          ...
          >
            <div className="card" style={{ padding: '12px', background: 'hsla(0,0%,100%,0.02)' }}>
              <div style={{ fontSize: '0.6rem', fontWeight: 800, color: 'hsl(var(--text-muted))' }}>
                DICE
              </div>
              <div style={{ fontSize: '1.25rem', fontWeight: 900 }} className="text-gradient">
                {results.dice}
              </div>
            </div>
            <div className="card" style={{ padding: '12px', background: 'hsla(0,0%,100%,0.02)' }}>
