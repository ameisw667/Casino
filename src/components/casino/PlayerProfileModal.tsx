      ...
      >
        ...
        <div
          style={{
            ...
            background:
              'linear-gradient(135deg, hsla(var(--primary), 0.2), hsla(var(--secondary), 0.2))',
            position: 'relative',
          }}
        >
          <button
        ...
        <div style={{ padding: isMobile ? '0 24px 32px' : '0 40px 40px', marginTop: '-40px' }}>
          ...
          >
            ...
            <div style={{ paddingBottom: '8px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span
                  style={{ fontSize: '0.8rem', fontWeight: 700, color: 'hsl(var(--text-muted))' }}
                >
                  {rank} Rank
                </span>
              </div>
          ...
          >
            <div
              className="glass"
              style={{ padding: isMobile ? '16px' : '20px', borderRadius: '20px' }}
            >
              <div
                style={{
              ...
              <div style={{ fontSize: isMobile ? '1.1rem' : '1.25rem', fontWeight: 900 }}>
                {mockStats.totalWagered}
              </div>
            </div>
            <div
              className="glass"
