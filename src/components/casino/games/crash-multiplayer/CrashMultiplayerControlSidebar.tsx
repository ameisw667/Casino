...
interface CrashMultiplayerControlSidebarProps {
  isMobile: boolean;
  balance: number;
  betAmount: number;
  multiplier: number;
  ...
  setIsAutoBetting: (auto: boolean) => void;
  setBetAmount: (amount: number) => void;
  setIsAutoCashoutEnabled: (updater: (prev: boolean) => boolean) => void;
  updateAutoSettings: (updater: Partial<AutoBetSettings>) => void;
  handleQuickBet: (amount: number) => void;
  handleStart: () => void;
  handleCashout: () => void;
  cashoutButtonRef: RefObject<HTMLButtonElement | null>;
}

export function CrashMultiplayerControlSidebar({
  isMobile,
  balance,
  betAmount,
  multiplier,
  ...
  handleCashout,
  cashoutButtonRef,
}: CrashMultiplayerControlSidebarProps) {
  return (
    <div
