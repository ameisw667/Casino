      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '0.75rem', color: '#b1bad3', fontWeight: 700 }}>
          ...
          <tbody>
            {leaders.map((leader, i) => (
              ...
              >
                ...
                <td
                  data-label="Wagered"
                  style={{ padding: '16px', fontSize: '0.85rem', fontWeight: 900 }}
                >
                ...
                <td
                  ...
                  style={{
                    ...
                    fontSize: '0.85rem',
                    fontWeight: 900,
                    color: leader.profit >= 0 ? '#00e701' : '#ff4d4d',
                  }}
                >
