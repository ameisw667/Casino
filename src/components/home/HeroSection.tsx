    ...
    >
      ...
      >
        <div style={{ maxWidth: isMobile ? '100%' : '800px' }}>
          ...
          >
            Experience the thrill of high-stakes gaming. Provably fair wins and{' '}
            <span style={{ color: '#fff', fontWeight: 900 }}>Instant Crypto Withdrawals</span>.
          </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <div style={{ display: 'flex', color: '#00b67a' }}>
                  {[1, 2, 3, 4, 5].map((i) => (
                    <Star key={i} size={22} fill="#00b67a" />
                  ))}
                </div>
            ...
            {liveWithdrawals.slice(0, 4).map((w, i) => (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div
                    style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.4)', fontWeight: 600 }}
                  >
                    Just won
                  </div>
                </div>
                <div style={{ fontSize: '1rem', fontWeight: 1000, color: 'hsl(var(--primary))' }}>
