...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      purge_closed_risk_events: { Args: never; Returns: undefined };
      ...
      run_risk_event_purge_job: { Args: never; Returns: undefined };
      ...
      settle_daily_race:
        { Args: never; Returns: Json } | { Args: { p_race_date: string }; Returns: Json };
      settle_game_bet:
        | {
            Args: {
              p_amount: number;
