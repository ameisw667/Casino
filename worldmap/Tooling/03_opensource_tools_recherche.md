...
> **Entscheidung (Jan, 2026-08-28):** Aus allen recherchierten Kandidaten bleiben ausschließlich **Toxiproxy** und **dependency-cruiser** als künftige Themen erhalten. Alle übrigen Kandidaten sowie die detaillierten Recherche-Durchläufe wurden bewusst aus dem aktiven Plan entfernt. Das Quellenverzeichnis bleibt vollständig erhalten.
