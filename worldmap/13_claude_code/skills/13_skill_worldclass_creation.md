...
| Bedarf                                              | Artefakt                                                                                      |
| --------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| Kandidaten und Priorisierung                        | [`agents/11_agenten_kandidaten_evaluation.md`](../agents/11_agenten_kandidaten_evaluation.md) |
| Agenten-Lebenszyklus und Sicherheitsgates           | [`agents/12_workflow_agent_creation.md`](../agents/12_workflow_agent_creation.md)             |
