...
> **Status:** Execution-Ready · **Stand:** 2026-09-07 · **Owner:** LLM (100 % LLM-Zuständigkeit) · **Scope:** Kaskadierender Buchstabenfall (`letter-cascade`) mit elastischer Federkraft für Rundenstarts und Mega-Multiplikatoren (`src/components/casino/jackpot/JackpotBanner.tsx`).
