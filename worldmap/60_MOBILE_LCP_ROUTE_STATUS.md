...
| `/games`                   | 1,244 / 2,092 s | 1,900 / 2,176 s |  ✅  | Brand-Icon via Bild-Preload früh entdeckt                             | [06](../workspace/domains/frontend/T_FRONTEND/Planungsdateien/06_mobile_lcp_games_plan.md)             | Verifiziert   |
...
| `/games/crash-multiplayer` | 1,828 / 1,496 s | 1,972 / 1,516 s |  ✅  | Brand-Icon nach mobilem SSR-Grid-Override vor Hydration früh sichtbar | [07](../workspace/domains/frontend/T_FRONTEND/Planungsdateien/07_mobile_lcp_crash_multiplayer_plan.md) | Verifiziert   |
| `/games/dice`              | 2,088 / 1,452 s | 2,876 / 2,512 s |  🔴  | Mobile-Felt-CSS-Ressource, 24.742 B, spät entdeckt                    | [08](../workspace/domains/frontend/T_FRONTEND/Planungsdateien/08_mobile_lcp_dice_plan.md)              | Geplant       |
| `/games/dice/v2`           | 1,448 / 1,464 s | 2,476 / 2,372 s |  ✅  | Mobile-Felt-CSS-Ressource; geringer Puffer                            | —                                                                                                      | Verifiziert   |
| `/games/roulette`          | 1,516 / 1,496 s | 5,604 / 5,444 s |  🔴  | Text nach `mounted`-/Bühnen-Gate                                      | [09](../workspace/domains/frontend/T_FRONTEND/Planungsdateien/09_mobile_lcp_roulette_plan.md)          | Geplant       |
| `/games/slots`             | 1,356 / 1,356 s | 4,808 / 5,032 s |  🔴  | Text nach `mounted`-Gate                                              | [10](../workspace/domains/frontend/T_FRONTEND/Planungsdateien/10_mobile_lcp_slots_plan.md)             | Geplant       |
| `/games/slots/v2`          | 1,436 / 1,480 s | 2,532 / 2,544 s |  🔴  | Brand-Icon, geringfügig über Ziel                                     | [11](../workspace/domains/frontend/T_FRONTEND/Planungsdateien/11_mobile_lcp_slots_v2_plan.md)          | Geplant       |
| `/history`                 | 1,852 / 1,708 s | 3,712 / 2,968 s |  🔴  | Brand-Icon; anonyme Datenbasis                                        | [12](../workspace/domains/frontend/T_FRONTEND/Planungsdateien/12_mobile_lcp_history_plan.md)           | Geplant       |
| `/lab`                     | 1,860 / 1,804 s | 6,828 / 5,324 s |  🔴  | Text hinter Canvas-/Preloader-Initialisierung                         | [13](../workspace/domains/frontend/T_FRONTEND/Planungsdateien/13_mobile_lcp_lab_plan.md)               | Geplant       |
| `/leaderboard`             | 1,372 / 1,576 s | 2,784 / 3,224 s |  🔴  | Brand-Icon                                                            | [14](../workspace/domains/frontend/T_FRONTEND/Planungsdateien/14_mobile_lcp_leaderboard_plan.md)       | Geplant       |
| `/refactoring`             | 1,308 / 1,148 s | 1,308 / 1,148 s |  ✅  | Lade-Text                                                             | —                                                                                                      | Verifiziert   |
| `/sign-in`                 | 1,808 / 1,492 s | 3,308 / 2,464 s |  🔴  | Brand-Icon; ein Lauf über Ziel                                        | [15](../workspace/domains/frontend/T_FRONTEND/Planungsdateien/15_mobile_lcp_sign_in_plan.md)           | Geplant       |
| `/sign-up`                 | 1,556 / 2,216 s | 2,908 / 3,520 s |  🔴  | Brand-Icon                                                            | [16](../workspace/domains/frontend/T_FRONTEND/Planungsdateien/16_mobile_lcp_sign_up_plan.md)           | Geplant       |
| `/stats`                   | 1,596 / 1,644 s | 3,108 / 3,192 s |  🔴  | Brand-Icon plus Daten-/Chart-Hydration                                | [17](../workspace/domains/frontend/T_FRONTEND/Planungsdateien/17_mobile_lcp_stats_plan.md)             | Geplant       |
| `/vault`                   | 1,408 / 1,492 s | 5,268 / 5,564 s |  🔴  | Profiltext nach `mounted`-/Daten-Gate                                 | [18](../workspace/domains/frontend/T_FRONTEND/Planungsdateien/18_mobile_lcp_vault_plan.md)             | Geplant       |
...
| `/testing/fe-06-crash`           | 1,120 / 1,116 s | 5,840 / 5,844 s |  🔴  | [19](../workspace/domains/frontend/T_FRONTEND/Planungsdateien/19_mobile_lcp_testing_fe_06_crash_plan.md)   | Geplant       |
| `/testing/fe-25-big-win`         | 4,280 / 4,216 s | 4,280 / 4,216 s |  🔴  | [20](../workspace/domains/frontend/T_FRONTEND/Planungsdateien/20_mobile_lcp_testing_fe_25_big_win_plan.md) | Geplant       |
...
### /games/crash-multiplayer — finale Verifikation (2026-09-17)

Frischer isolierter Production-Build (`BUILD_ID xkCNVszxhUUASgCfpV5fz`) und lokaler Production-Server; Pixel 5, 4× CPU-Drosselung, 4G (150 ms Latenz, 1,6 Mbit/s Downlink, 750 kbit/s Uplink), ohne Interaktion. Alle Werte sind kontrollierte PerformanceObserver-Labwerte.

| Lauf |     FCP | finaler LCP | LCP-Kandidat          | LCP-Ressource                                                | Startzeit / Dauer / Transfergröße | Requests |
| ---- | ------: | ----------: | --------------------- | ------------------------------------------------------------ | --------------------------------- | -------: |
| 1    | 1,828 s |     1,972 s | `IMG.brand-logo-tilt` | `/_next/image?url=%2Fimages%2Fbrand-ace-icon.png&w=384&q=75` | 0,663 s / 1,210 s / 45.288 B      |       61 |
| 2    | 1,496 s |     1,516 s | `IMG.brand-logo-tilt` | `/_next/image?url=%2Fimages%2Fbrand-ace-icon.png&w=384&q=75` | 0,246 s / 1,138 s / 45.288 B      |       61 |

Belegter Befund und minimale Änderung: Im frischen Ausgangslauf war der SSR-`H1` beim DOMContentLoaded vorhanden, lag mit `x=635` aber außerhalb des Pixel-5-Viewports, weil seine Inline-Desktopwerte vor Hydration die vorhandene Mobile-CSS überstimmten. Ein neuer route-spezifischer Regressionstest war erst rot und nach der Änderung 3/3 grün. Ausschließlich die bestehende `@media (max-width: 960px)`-Regel dieser Route übersteuert jetzt `grid-template-columns` sowie die zwei Ordnungswerte mit `!important`; keine Admin-, API-, Wallet- oder Spielregel wurde verändert. Beide frischen PerformanceObserver-Lab-LCP-Werte liegen bei ≤ 2,5 s; die Route ist verifiziert.
