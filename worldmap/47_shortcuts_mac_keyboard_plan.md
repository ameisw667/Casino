...
> **Status:** Execution-Ready · **Stand:** 2026-09-07 · **Owner:** LLM (100 % LLM-Zuständigkeit) · **Scope:** Interaktives 3D-Tastatur-Modell (`mac-keyboard`) mit leuchtenden Tastenkappen bei Tastenanschlag (`src/components/layout/NavigationShortcuts.tsx`).
