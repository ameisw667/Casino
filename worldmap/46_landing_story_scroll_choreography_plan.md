...
> **Status:** Execution-Ready · **Stand:** 2026-09-07 · **Owner:** LLM (100 % LLM-Zuständigkeit) · **Scope:** Parallaktische Scroll-Synchronisation (`scroll-choreography`) der Lobby-Storyline und VIP-Sektionen (`src/components/home/LobbySectionHeader.tsx`).
