...
> **Status:** Execution-Ready · **Stand:** 2026-09-07 · **Owner:** LLM (100 % LLM-Zuständigkeit) · **Scope:** Implementierung einer geführten, cineastischen VIP-Feature-Tour (`sticky-scroll-cards`) im Onboarding-Dialog (`src/components/layout/OnboardingFlow.tsx`).
