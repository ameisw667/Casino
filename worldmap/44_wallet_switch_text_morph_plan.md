...
> **Status:** Execution-Ready · **Stand:** 2026-09-07 · **Owner:** LLM (100 % LLM-Zuständigkeit) · **Scope:** Nahtloses SVG-Glyphen-Morphing (`text-morph`) beim Umschalten zwischen Fiat- und Krypto-Währung im Header-Wallet-Chip (`src/components/layout/MainHeader.tsx`).
