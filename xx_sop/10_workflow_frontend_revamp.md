...
- **2. Touch-Targets auf Mobile teilweise unter 44px:**
  Einige Jeton-Auswahl-Buttons in Blackjack/Roulette unterschreiten auf kleinen Screens die empfohlene Touch-Fläche von $44\times 44\text{px}$ (Korrekturrichtlinie: [`xx_sop/16_motion_and_ui_polish.md`](./16_motion_and_ui_polish.md)).
