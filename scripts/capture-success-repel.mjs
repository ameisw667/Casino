...
async function main() {
  ...
  for (const f of ['prop_repel_1_vip_badge.png', 'prop_repel_2_provably_fair.png', 'prop_repel_3_catalog_header.png']) {
  ...
  const file1Docs = path.join(DOCS_DIR, 'success_repel_1_vip_badge.png');
  const file1Brain = path.join(BRAIN_DIR, 'success_repel_1_vip_badge.png');
  ...
  const file2Docs = path.join(DOCS_DIR, 'success_repel_2_provably_fair.png');
  const file2Brain = path.join(BRAIN_DIR, 'success_repel_2_provably_fair.png');
  ...
  const file3Docs = path.join(DOCS_DIR, 'success_repel_3_catalog_header.png');
  const file3Brain = path.join(BRAIN_DIR, 'success_repel_3_catalog_header.png');
  ...
  await browser.close();
  console.log('Done capturing Text Repel success screenshots!');
}
