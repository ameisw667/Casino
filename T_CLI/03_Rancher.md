...
- [`docker/observability/docker-compose.yml`](../docker/observability/docker-compose.yml), `package.json` (`observability:up`/`observability:down`) — realer Compose-Use-Case.
