...
> Abgrenzung: Externe APIs, die die App selbst aufruft → [01_api.md](../T_API/01_api_breakdown.md). MCP-Server-Nutzung → [01_mcp.md](../T_MCP/01_mcp.md).
...
| 21  | n8n als visuelle Workflow-Automation                           | 🔴 Geplant — eigene VPS-Instanz (Hostinger) vorhanden, Deep-Dive-Roadmap (Lead-Gen/Enrichment/Outreach-Mastery) geplant, Details: [`07_n8n_deepdive.md`](../../Z_LLM/07_n8n_deepdive.md)                                                                                                                                                                                  | Top 90% | R: Niedrig · I: Mittel · L: Hoch · A: Mittel    |
