...
| 10  | [DB-Test-Schicht](../docs/database/10_automatisierte_db_testschicht.md)           |  **6**  | Top 90 % |   🟢   |        **Ja**⁵         | **Ja** — [`10_database_testschicht_pgtap.md`](./10_database_testschicht_pgtap.md)                   | Sicherheitsnetz für _künftige_ Änderungen, kein akutes Live-Risiko                         |
