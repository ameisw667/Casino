...
| Surface neutral (Jans Standard für Kästen) | `#111111` / `#121212` / `#141414`, Border `#222222`/`#262626`                                            | Leaderboard-Familie — Scope festgelegt (Jan 2026-09-06): nur /games, /history, /vault, /stats + GameSkeleton; Blackjack-Tisch-Look bleibt Ausnahme |
