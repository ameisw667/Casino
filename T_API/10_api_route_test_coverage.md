...
3. Fehlermatrix für Auth, Validierung, Origin, Limit und Provider-Ausfall priorisieren.
...
- Freigabegrenze: Nur Mocks; keine echten Provider oder Geldpfade.
...
- [Vitest](https://vitest.dev/guide/), abgerufen 2026-09-09.

## Eindeutiger nächster Schritt

Fehlermatrix für Auth, Validierung, Origin, Limit und Provider-Ausfall priorisieren.