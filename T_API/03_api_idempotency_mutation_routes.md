...
3. Money-Routen read-only gegen Header-, Schema- und Service-Contract abgleichen.
...
- Freigabegrenze: Geldpfadänderungen sind K4 und brauchen Jans Freigabe.
...
- [Stripe Idempotency](https://docs.stripe.com/api/idempotent_requests), abgerufen 2026-09-09.

## Eindeutiger nächster Schritt

Money-Routen read-only gegen Header-, Schema- und Service-Contract abgleichen.