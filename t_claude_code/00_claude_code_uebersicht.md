...
> **Status:** 🟢 Vollständig aufgeschlüsselt · **Stand:** 2026-09-14 · **Owner:** Jan / LLM
...
|  3  | **Custom Agents (Subagents)**            |  **10 %**  |                                **Top 20 %**                                | [`01_3_custom_agents.md`](01_3_custom_agents.md)           | Spezial-Helfer für einzelne Teilaufgaben, die eigenständig arbeiten (z. B. ein Sicherheits-Check nur für Datenbank-Änderungen).           | `.claude/agents/` im Projekt                                                                  |
...
|  6  | **Memory Files**                         |  **5 %**   |                    **Top 44 %** (Re-Rating 2026-09-16)                     | [`01_6_memory_files.md`](01_6_memory_files.md)             | Die konkreten Notizen, die sich Claude Code von sich aus über frühere Gespräche zu diesem Projekt merkt — die Dateien hinter Kategorie 5. | `C:\Users\hambu\.claude\projects\V--VibeCoding-Casino\memory\` (außerhalb des Projektordners) |
...
**Rechnerischer Schnitt über alle 10 Kategorien: (8+59+20+30+60+44+48+51+68+55)/10 = Top 44 %** (Memory-Files-Term auf den Re-Rating-Stand 2026-09-16 gezogen; vorher Top 45 %, davor Top 47 % mit dem veralteten Commands-Wert).

**Gewichteter Schnitt (Niveau × Gewichtung, ergänzt 2026-09-05 auf Jans Wunsch): (8·0,20 + 59·0,10 + 20·0,10 + 30·0,08 + 60·0,12 + 44·0,05 + 48·0,10 + 51·0,07 + 68·0,08 + 55·0,10) = 40,61 → Top 41 %** (Memory-Files-Term 55 → 44 nach Re-Rating 2026-09-16; die Anzeige bleibt rechnerisch bei Top 41 %). Der gewichtete Wert ist **besser** als der ungewichtete, weil die stärkste Kategorie (CLAUDE.md, Top 8 %) die höchste Gewichtung trägt und die schwächsten (Hooks, Permissions) nur 8–10 % wiegen — das System ist real stärker, als der flache Schnitt aussagt.
...
|  7   | **6 — Memory Files**                         |       Top 44 % (Re-Rating 2026-09-16)        | 1 von 4 vorgesehenen Memory-Typen (`user`) hat 0 Einträge trotz 836 Sitzungsstarts; `reference` ist seit 2026-09-04 belegt (1 Eintrag, Beleg [`01_6_memory_files.md`](01_6_memory_files.md) Zeile 17) — der veraltete Fakt-Claim dieser Zeile („2 von 4 Typen 0 Einträge“) ist am 2026-09-16 korrigiert | [10 Pläne 06_u01–u10](Planungsdateien/06_u10_faktenluecke_plan.md)                                                                                              | 🔵 Execution-Ready (10 Pläne bereit; 3 davon ausgeführt 2026-09-16, Rest wartet auf Jan-Freigabe) |
|  8   | **4 — Commands & Workflow-Automatisierung**  | Top 30 % (gewichtet neu bewertet 2026-09-13) | Projekt-Referenz deckt 43 Scripts, 12 CI-Workflows und Hook-Grenzen ab; Rest-Bottleneck: globale 58-Commands-Governance wartet auf Jan                                                                                                                                                                  | [`01_4_command_workflow.md`](01_4_command_workflow.md)                                                                                                          | 🟡 teilweise (Projekt ✅, globale Governance wartet auf Jan)                                      |
|  9   | **3 — Custom Agents (Subagents)**            |                   Top 20 %                   | 2 von 3 gebauten Agenten weiterhin ohne `CLAUDE.md`-Router-Zeile — inzwischen aber evaluiert (20/20 Läufe ✅, 2026-08-30); `casino-code-explorer` ist Pilot, `casino-residue-scout` Draft (3 reale Prüfungen offen); Router-Zeilen bleiben Jan-Pflicht                                                  | [`agents/12_workflow_agent_creation.md`](agents/12_workflow_agent_creation.md) (Registry/Governance)                                                            | 🟡 teilweise (evaluiert ✅, Router-Zeilen Jan-Pflicht)                                            |
...
| **Stand**                         | **Top 27 %** Endstand nach allen 10 Plänen (vorher Top 54 %), ausgeführt am 2026-09-14                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| **Offen (Jan-Gates)**             | ① ~~Crash-Loop Option-Wahl~~ **entschieden 2026-09-16: X3 (4,20)** — ebenso WalletService **W3 (4,25)**; Umsetzung in separaten Implementation-Plänen, Reihenfolge **X3 zuerst** (kein Geldkontakt, bringt die ersten Tests). **Klartext-Erklärung beider Umbauten: [`01_15_03b_w3_x3_erklaerung.md`](01_15_03b_w3_x3_erklaerung.md)** · ② Baustein-E A/B/C (Position 7, 3 Bullets in `01_1_claude_md.md` §4) · ③ Read-Deny `database.types.ts` (Plan R08 L1, projekt-weite `settings.json`, Dateiinhalt fertig in `Planungsdateien/03a_r08_generierter_code_plan.md` §5) |
