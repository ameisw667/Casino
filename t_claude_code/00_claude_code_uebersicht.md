...
|  6  | **Memory Files**                         |  **5 %**   |                                **Top 55 %**                                | [`01_6_memory_files.md`](01_6_memory_files.md)             | Die konkreten Notizen, die sich Claude Code von sich aus über frühere Gespräche zu diesem Projekt merkt — die Dateien hinter Kategorie 5. | `C:\Users\hambu\.claude\projects\V--VibeCoding-Casino\memory\` (außerhalb des Projektordners) |
...
**Rechnerischer Schnitt über alle 10 Kategorien: (8+59+20+30+60+55+48+51+68+55)/10 = Top 45 %** (vorher Top 47 % mit dem veralteten Commands-Wert).

**Gewichteter Schnitt (Niveau × Gewichtung, ergänzt 2026-09-05 auf Jans Wunsch): (8·0,20 + 59·0,10 + 20·0,10 + 30·0,08 + 60·0,12 + 55·0,05 + 48·0,10 + 51·0,07 + 68·0,08 + 55·0,10) = Top 41 %.** Der gewichtete Wert ist **besser** als der ungewichtete, weil die stärkste Kategorie (CLAUDE.md, Top 8 %) die höchste Gewichtung trägt und die schwächsten (Hooks, Permissions) nur 8–10 % wiegen — das System ist real stärker, als der flache Schnitt aussagt.
...
|  4   | **6 — Memory Files**                         |                   Top 55 %                   | 2 von 4 vorgesehenen Memory-Typen (`user`, `reference`) haben 0 Einträge trotz 836 Sitzungsstarts                                                                                                                                                      | — _(noch keine Planung)_                                                                                                                                        | 🔵 geplant/wartet                                            |
...
|  6   | **8 — MCP-Server & externe Programme**       |                   Top 51 %                   | ≈ 15–16 Account-weite MCP-Server ohne projektbezogene Begründung, plus tote Permission-Einträge                                                                                                                                                        | — _(noch keine Planung)_                                                                                                                                        | 🔵 geplant/wartet                                            |
|  7   | **7 — Context-Management & Token-Ökonomie**  |                   Top 48 %                   | Kein dokumentiertes Kontext-Budget-Protokoll in `CLAUDE.md` (Baustein E fertig, nicht freigegeben); Laufzeit-Hälfte inzwischen durch [`01_15_token_oekonomie_effizienz.md`](01_15_token_oekonomie_effizienz.md) abgedeckt (§1c unten)                  | [`01_7_context_management.md`](01_7_context_management.md) (Baustein E) + [`01_15_token_oekonomie_effizienz.md`](01_15_token_oekonomie_effizienz.md) (Laufzeit) | 🟡 teilweise (Laufzeit 🟢, Baustein-E-Freigabe offen)        |
...
|  7   | **6 — Memory Files**       | Top 55 % |   5 %   | **275** |
|  8   | **4 — Commands**           | Top 30 % |   8 %   | **240** |
...
|                                   |                                                                                                                                                                                                                                                    |
| --------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Prio**                          | **3** — Regel-Arbeit abgeschlossen; Rest wartet auf Jans 2 Entscheidungen + erste Messwerte. Erhebung auf Prio 2 nach 2–3 Wochen gelebter Praxis mit echten `/cost`-Werten (Routine in 15a §3).                                                    |
...
| **Offen (Jan-Gates)**             | ① Crash-Loop Option-Wahl (`01_15` Position 3, 4-Optionen-Matrix in `Planungsdateien/03_..._plan.md` §2a) · ② Baustein-E A/B/C (Position 7, 3 Bullets in `01_1_claude_md.md` §4)                                                                    |
