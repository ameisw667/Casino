# 11 — API: Doku-Integrität und kanonische Quelle

> **Status:** 🟢 Execution-Ready+ · **Stand:** 2026-09-09 · **Owner:** LLM
> **Scope:** Zähler, Links, Standdaten und Status. Keine Installation, Verbindung, Konfiguration, Secret-Ausgabe oder externe Datenmutation.

## Ausgangslage und Zielbild

**Nachweisbarer Ist-Zustand:** 56 kollidiert mit dem gemessenen und kanonisch dokumentierten 59er-Bestand. Die lokale Messung vom 2026-09-09 zählt 59
...
3. Alte Zähler historisch markieren und Links prüfen.
...
- Freigabegrenze: Keine Worldmap-Datei außerhalb dieses Scopes ändern.
...
- [Dokumentations-SOP](../../../../xx_sop/12_workflow_dokument_qualitaet.md), abgerufen 2026-09-09.

## Eindeutiger nächster Schritt

Alte Zähler historisch markieren und Links prüfen.
