# 02 — API: Response-Envelope-Konsistenz

> **Status:** 🟢 Execution-Ready+ · **Stand:** 2026-09-09 · **Owner:** LLM
> **Scope:** Erfolgs- und Fehlerverträge. Keine Installation, Verbindung, Konfiguration, Secret-Ausgabe oder externe Datenmutation.

## Ausgangslage und Zielbild

**Nachweisbarer Ist-Zustand:** Neue Routen folgen dem Standard; Altbestand nur opportunistisch. Die lokale Messung vom 2026-09-09 zählt 59
...
3. 59 Routen in Standard, dokumentierte Ausnahme und unbelegte Ausnahme klassifizieren.
...
- Freigabegrenze: Webhook- und Streaming-Verträge nicht stillschweigend ändern.
...
59 Routen in Standard, dokumentierte Ausnahme und unbelegte Ausnahme klassifizieren.
