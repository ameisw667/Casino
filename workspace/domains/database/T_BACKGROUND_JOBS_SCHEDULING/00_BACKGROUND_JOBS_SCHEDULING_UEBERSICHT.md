...
Gewicht erhalten doppelte bzw. verlorene Seiteneffekte, finale Fehlschläge und ihre Wiederherstellbarkeit. Werte und Status stammen aus der [10-Säulen-Aufschlüsselung](../../../../worldmap/00_WORLDMAP_STATUS.md).
...
|  3  | Retry/Failure-Handling — `pg_cron`                                                                  | **12**  | Top 15 % |   🟢   | Ja — [ausgeführt](../../../../xx_sop/20_background_jobs_scheduling.md) | Persistentes Run-Ledger und begrenzte Retries schützen Tagesjobs.                 |
...
- [Worldmap-Status (Kategorie 07)](../../../../worldmap/00_WORLDMAP_STATUS.md)
