...
| Typbindung der Clients (separater, bereits ausgeführter Plan)     | [`T_DATABASE/06_database_typsicherheit.md`](../../../../docs/archive/database/T_DATABASE/06_database_typsicherheit.md)                     |
