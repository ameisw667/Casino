...
|  1  | [Migrations-Disziplin](../../../../docs/database/01_migrations_und_versionierung.md)       | **10**  |  Top 10 %   |         **Ja**¹         | **Ja** — [`01_database_migrations_disziplin.md`](../../../../docs/archive/database/T_DATABASE/01_database_migrations_disziplin.md) | Fehlerhafte DDL kann jede andere Säule gleichzeitig beschädigen (Systemvoraussetzung)      |
...
|  6  | [Typsicherheit & Typegen](../../../../docs/database/06_typsicherheit_typegen.md)           |  **6**  |  Top 15 %   |         **Ja**⁶         | **Ja** — [`06_database_typsicherheit.md`](../../../../docs/archive/database/T_DATABASE/06_database_typsicherheit.md)               | Reine Entwicklerergonomie, Fehler werden zur Build-Zeit gefangen                           |
