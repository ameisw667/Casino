...
> Abgrenzung: Externe APIs, die die App selbst aufruft → [01_api.md](../../database/T_API/01_api_breakdown.md). CLI-Tool-Nutzung → [02_cli.md](../T_CLI/02_cli.md).
...
> CLI-Pendant (`gh`) siehe [02_cli.md](../T_CLI/02_cli.md) — gleicher Nachweis, deckungsgleicher Datenvergleich CLI vs. MCP.
...
> Vorschläge des LLM für weitere MCP-Kandidaten, die aktuell in keinem Worldmap-Dokument stehen. Noch nicht bewertet oder freigegeben — reine Anregung zur Diskussion. Recherche-Kontext (Methodik, alle Detailergebnisse): [`03_opensource_tools_recherche.md`](../../../../worldmap/Tooling/03_opensource_tools_recherche.md).
