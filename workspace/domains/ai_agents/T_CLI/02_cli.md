...
> Abgrenzung: Externe APIs, die die App selbst aufruft → [01_api.md](../../database/T_API/01_api_breakdown.md). MCP-Server-Nutzung → [01_mcp.md](../T_MCP/01_mcp.md).
...
| 21  | n8n als visuelle Workflow-Automation                           | 🔴 Geplant — eigene VPS-Instanz (Hostinger) vorhanden, Deep-Dive-Roadmap (Lead-Gen/Enrichment/Outreach-Mastery) geplant, Details: [`07_n8n_deepdive.md`](../../../../workspace/domains/ai_agents/Z_LLM/07_n8n_deepdive.md)                                                                                                                                    | Top 90% | R: Niedrig · I: Mittel · L: Hoch · A: Mittel    |
...
> MCP-Pendant (interaktiver Agenten-Debugger) siehe [01_mcp.md](../T_MCP/01_mcp.md).
...
> MCP-Pendant siehe [01_mcp.md](../T_MCP/01_mcp.md) — gleicher Nachweis, deckungsgleicher Datenvergleich CLI vs. MCP.
...
> Vorschläge des LLM für weitere CLI-Kandidaten, die aktuell in keinem Worldmap-Dokument stehen. Noch nicht bewertet oder freigegeben — reine Anregung zur Diskussion. Recherche-Kontext (Methodik, alle Detailergebnisse): [`03_opensource_tools_recherche.md`](03_opensource_tools_recherche.md).
