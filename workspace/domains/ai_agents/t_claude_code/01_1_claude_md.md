...
|  7  | Subagent- & Delegations-Harness        | [`01_3_custom_agents.md`](01_3_custom_agents.md)                                                                                                                        | 🟢 vollständig (alle 3 Agenten Pilot, `CLAUDE.md:114` nennt alle drei mit Status-Label)                  |
|  8  | Session-Memory & Continuous Learning   | [`01_5_session_memory.md`](01_5_session_memory.md) (A/B/C-Gate kanonisch: [`01_5_05_fehler_taxonomie_governance.md`](01_5_05_fehler_taxonomie_governance.md) + Plan 25) | 🟡 Abschnitt „Session-Kontinuität" in `CLAUDE.md` übernommen; Options-Gate A/B/C offen (entscheidet Jan) |
...
- **Prompt-Caching-Regel (ergänzt 2026-09-14, Plan 7):** System-Prompt-Reihenfolge (CLAUDE.md-Imports, MCP-Listing) zwischen Turns stabil halten — keine ungefragten Umsortierungen; Cache-Hits machen wiederholte Fan-out-Header billig.
```

**Freigabe-Vorlage (aktualisiert 2026-09-14, Plan 7):** Der Umfang der offenen A/B/C-Entscheidung hat sich verkleinert — die **Model-Routing-Matrix** von Baustein E ist seit Plan 4 direkt in `CLAUDE.md` § Model-Routing verankert und entfällt aus dem Baustein. Offen bleibt nur noch: (A) Handoff- & Checkpoint-Disziplin-Bullet, (B) Token-/Tool-Budget-Bullet, (C) Anti-Halluzinations-Gate-Bullet. Jan-Entscheidung: welche dieser 3 Bullets in `CLAUDE.md` § Session-Kontinuität/Nähe einziehen — oder Baustein E weiterhin ganz ruhen lassen.
