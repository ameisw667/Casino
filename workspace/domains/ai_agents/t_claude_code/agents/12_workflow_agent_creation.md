...
- **Entscheidungen vom 2026-08-30 (Jan-Direktive, teils delegiert):**
  ...
  - Für Residue Scout (umbenannt am 2026-08-30 von „Cleanup Residue Finder" auf Jans Wunsch, Frontmatter-`name` `casino-cleanup-residue-finder` → `casino-residue-scout`, Datei `11_cleanup_residue_finder.md` → `11_residue_scout.md`) ist die Registry-Zeile aktuell (Agent ist gebaut, Status **Pilot** seit 2026-09-18 — 3 reale read-only Prüfungen bestanden, siehe §2.1).
...
| 11  | `casino-residue-scout`     | `.claude/agents/11_residue_scout.md`            | Report/Explorer              | **Pilot** (Eval 10/10 ✅ + 3 reale Prüfungen, 2026-09-18)      | v0.2.0  | **89/100 (B)**    |
...
- **2026-09-18:** `casino-residue-scout` Draft → Pilot (§2.1) — drei reale read-only Prüfungen gegen den echten Repo-Stand bestanden (Protokoll `.claude/agent-evals/11_residue_scout/runs/2026-09-18_real_world_checks.md`), zusätzlich zur bereits bestandenen Fixture-Evaluierung. Damit sind alle drei projektlokalen Agenten (06, 11, 31) mindestens Pilot; keine Score- oder Tool-Änderung, daher keine Versions-Bump-Pflicht nach `xx_sop/13` §5.
