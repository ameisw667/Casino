# 10 — Mobile-LCP: `/games/slots`

> **Status:** Geplant · **Stand:** 2026-09-13 · **Scope:** Ausschließlich Mobile-LCP für `/games/slots`. Keine Admin-, API-, Wallet- oder außerhalb des belegten Renderpfads liegende Produktverhaltensänderung.

## Route und dokumentierte Baseline

| Messwert               | PerformanceObserver-Lab-Baseline |
| ---------------------- | -------------------------------- |
| FCP Lauf 1 / 2         | 1,356 / 1,356 s                  |
| finaler LCP Lauf 1 / 2 | 4,808 / 5,032 s                  |
| Dominanter LCP-Befund  | Text nach mounted-Gate           |
...
- Der finale LCP-Kandidat ist Text nach dem mounted-Gate. Beide Läufe liegen deutlich über dem Ziel.
- Der dokumentierte dominante LCP-Befund bestimmt den Untersuchungsumfang dieser Route.

## Noch zu prüfende Hypothesen

- Die erste Mobile-Ansicht ist bis Hydration oder Bühnenbereitschaft leer beziehungsweise nicht LCP-fähig.
...
- **Ursachenanalyse:** Die LCP-Verzögerung ist text- und Gate-getrieben. Ein Bild-Workaround adressiert den dokumentierten Kandidaten nicht.
- **Minimaler Fixpfad:** Nur eine minimale SSR- beziehungsweise früh verfügbare funktionale Mobile-Textgrundansicht vor dem nachgewiesenen Gate planen.
...
- Teilt den Mounted-/Bühnen-Pfad mit Roulette und Crash-Multiplayer; keine pauschale Komponentenänderung ohne route-spezifische Tests.
