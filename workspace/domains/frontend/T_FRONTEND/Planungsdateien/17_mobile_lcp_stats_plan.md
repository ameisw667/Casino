...
> **Status:** Geplant · **Stand:** 2026-09-13 · **Scope:** Ausschließlich Mobile-LCP für `/stats`. Keine Admin-, API-, Wallet- oder außerhalb des belegten Renderpfads liegende Produktverhaltensänderung.

## Route und dokumentierte Baseline

| Messwert               | PerformanceObserver-Lab-Baseline       |
| ---------------------- | -------------------------------------- |
| FCP Lauf 1 / 2         | 1,596 / 1,644 s                        |
| finaler LCP Lauf 1 / 2 | 3,108 / 3,192 s                        |
| Dominanter LCP-Befund  | Brand-Icon plus Daten-/Chart-Hydration |
...
- Brand-Icon sowie Daten-/Chart-Hydration sind dokumentiert; beide LCP-Läufe liegen über dem Ziel.
- Der dokumentierte dominante LCP-Befund bestimmt den Untersuchungsumfang dieser Route.

## Noch zu prüfende Hypothesen

- Das Brand-Icon ist der finale Kandidat, während Daten-/Chart-Hydration den frühen Renderpfad zusätzlich belastet.
...
- **Ursachenanalyse:** Die Route verbindet den gemeinsamen Icon-Pfad mit route-spezifischer Daten-/Chart-Hydration. Beide Effekte müssen getrennt belegt werden, damit kein breiter Chart-Refactor erfolgt.
- **Minimaler Fixpfad:** Erst den finalen Kandidaten und seine Discovery prüfen; nur bei Beleg die kleinste Entkopplung nicht-kritischer Daten-/Chart-Arbeit planen.
...
- Brand-Icon mit verwandten Routen gemeinsam untersuchen; anonyme Datenbasis bleibt als route-spezifische Messgrenze bestehen.
