...
> **Status:** 🟢 Completed & Archived · **Stand:** 2026-09-11 · **Owner:** LLM (100 % LLM-Zuständigkeit) · **Scope:** Chromatische Aberrations-Welle (`ripple-transition`) zentriert vom Auslöser-Klick bei Runden-Reset (`src/components/casino/GameLayout.tsx`).
